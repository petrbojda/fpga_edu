...
HD_PWD='/home/petr/Projects/fpga_edu/zedboard/wrk/ps_freertos_systems/rtl/vivado/first_freertos.runs/p_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p_system_processing_system7_0_0.tcl
