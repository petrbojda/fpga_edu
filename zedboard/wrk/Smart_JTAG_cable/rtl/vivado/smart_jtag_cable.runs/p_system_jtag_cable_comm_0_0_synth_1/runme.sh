...
HD_PWD='/home/petr/Projects/fpga_edu/zedboard/wrk/Smart_JTAG_cable/rtl/vivado/smart_jtag_cable.runs/p_system_jtag_cable_comm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p_system_jtag_cable_comm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p_system_jtag_cable_comm_0_0.tcl
