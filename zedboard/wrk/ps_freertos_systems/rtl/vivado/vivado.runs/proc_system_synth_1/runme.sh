...
HD_PWD='/home/petr/Projects/fpga/zedboard/wrk/ps_freertos_systems/rtl/vivado/vivado.runs/proc_system_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proc_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proc_system.tcl
