...
C_SRCS += \
../third_party/unity/test/tests/testparameterized.c \
../third_party/unity/test/tests/testunity.c 

OBJS += \
./third_party/unity/test/tests/testparameterized.o \
./third_party/unity/test/tests/testunity.o 

C_DEPS += \
./third_party/unity/test/tests/testparameterized.d \
./third_party/unity/test/tests/testunity.d 


# Each subdirectory must supply rules for building sources it contributes
third_party/unity/test/tests/%.o: ../third_party/unity/test/tests/%.c
	@echo 'Building file: $<'
