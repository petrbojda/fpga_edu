...
HD_PWD='/home/petr/Projects/fpga/zedboard/wrk/ps_freertos_lwip/rtl/vivado/ps_basic_led.runs/ps_system_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_system_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_system_axi_gpio_0_0.tcl
